Class=[
  ...
  let printfun=(req)=>{
    ...
    req.map((item)=>{
        ...
        imagediv.setAttribute("class","outlet-image")

        let image=document.createElement("img")
        image.setAttribute("src","https://tinypng.com/images/social/website.jpg")
        ...
        let biewbutton=document.createElement("button")
        biewbutton.setAttribute("class","biew-button")
        biewbutton.innerHTML="View"


outletdiv.append(imagediv,heading,content,biewbutton)
